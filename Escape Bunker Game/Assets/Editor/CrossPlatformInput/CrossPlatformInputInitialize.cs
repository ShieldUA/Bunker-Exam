    ...
    public class CrossPlatformInitialize
    {
        ...
        private static void Enable()
        {
            ...
            switch (EditorUserBuildSettings.activeBuildTarget)
            {
                ...
                case BuildTarget.WSAPlayer: // Замінили WP8Player на WSAPlayer
        ...
        private static BuildTargetGroup[] buildTargetGroups = new BuildTargetGroup[]
        {
            ...
            BuildTargetGroup.WebGL, // Замінили WebPlayer на WebGL
            BuildTargetGroup.Android,
            BuildTargetGroup.iOS,
            BuildTargetGroup.WSA, // Замінили WP8 на WSA
        };
        ...
        private static BuildTargetGroup[] mobileBuildTargetGroups = new BuildTargetGroup[]
        {
            ...
            BuildTargetGroup.iOS,
            BuildTargetGroup.WSA, // Замінили WP8 на WSA
            BuildTargetGroup.WSA, // Замінили WP8 на WSA для мобільних платформ
        };
